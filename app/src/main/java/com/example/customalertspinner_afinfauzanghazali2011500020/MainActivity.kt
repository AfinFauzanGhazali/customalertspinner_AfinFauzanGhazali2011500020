...
class MainActivity : AppCompatActivity() {
    ...
    val logo = intArrayOf(
        R.drawable.logo_pangkalpinang, R.drawable.logo_bangka, R.drawable.logo_babar, R.drawable.logo_bateng,
        R.drawable.logo_basel, R.drawable.logo_belitung, R.drawable.logo_beltim
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val spnKabKota = findViewById<Spinner>(R.id.spinKabKota)
